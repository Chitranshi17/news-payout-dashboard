...
export default function BlogDetails() {
  const { state: blog } = useLocation(); // Get the blog data passed via the navigate function
  const navigate = useNavigate();

  // If there's no blog data, show an error message
  if (!blog) {
    return (
  ...
  return (
    <div className="p-6 md:p-10 animate-fade-in-up">
      ...
      <div className="prose lg:prose-lg max-w-4xl text-justify text-gray-700">
        ...
        {/* You might want to add the full content if available */}
      </div>
